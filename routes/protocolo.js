...
router.post('/',[
    ...
    check('boleta1').optional().if((value, { req }) => value && value.trim() !== '').notEmpty().withMessage('Faltan datos del segundo integrante'),
    check('boleta2').optional().if((value, { req }) => value && value.trim() !== '').notEmpty().withMessage('Faltan datos del tercer integrante'),
